  ...
  const categories = [
    {
      ...
      image: require('../../assets/images/category/category-one.png'),
      title: 'Formal Shoes',
    },
    {
      id: 'category-slider-item-two',
      image: require('../../assets/images/category/category-two.png'),
      title: 'Casual Shoes',
    },
    {
      id: 'category-slider-item-three',
      image: require('../../assets/images/category/category-three.png'),
      title: 'Sport Shoes',
    },
    {
